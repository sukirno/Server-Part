                    ...
                    <div class="row">
                        ...
                        <div class="col s12">
                            ...
                            <?php
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <a href="/admin/photo_reports/?act=clear&access_token=<?php echo admin::getAccessToken(); ?>">
...
<?php
    ...
    function draw($user)
    {
        ...
        <tr>
            ...
            <td><?php echo "<a href=\"/admin/photo/?id={$user['abuseToPhotoId']}\">To photo Id ({$user['abuseToPhotoId']})</a>"; ?></td>
            <td>
                <?php
