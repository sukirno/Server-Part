    ...
    ?>
        ...
        <div class="box-body">
            ...
            <form onsubmit="Post.rePost('<?php echo $profileInfo['username']; ?>'); return false;" class="repost_form" action="/<?php echo $profileInfo['username']; ?>/post" method="post">
                ...
                <textarea style="width: 420px;resize: none;height: 100px;margin-bottom: 20px;" name="postText" maxlength="400" placeholder="<?php echo $LANG['label-share-add-comment']; ?>"></textarea>
                <div class="choice">
