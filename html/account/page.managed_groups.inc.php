<?php
    ...
    if (!empty($_POST)) {
        ...
        if ($items_loaded != 0) {
            ...
            if ($result['items'] < $items_all) {
                ...
                <div class="more_cont">
                    <a class="more_link" href="#" onclick="Groups.managedGroupsMore('<?php echo $result['itemId']; ?>'); return false;"><?php echo $LANG['action-more']; ?></a>
    ...
    $page_title = $LANG['label-managed-groups']." | ".APP_TITLE;
                    ...
                    <div id="wrap1">
                        <div id="content">
                            ...
                            <div class="header">
                                ...
                                <a href="/account/managed_groups" class="title active"><?php echo $LANG['label-managed-groups']; ?></a>
                                <span class="divider">|</span>
                                <a href="/account/create_group" class="title"><?php echo $LANG['action-create-group']; ?></a>
                            </div>

                            <div id="managed_groups_cont" class="managed_groups_cont">
