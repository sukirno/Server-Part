<?php
    ...
    if (!empty($_POST)) {
        ...
        if ($items_loaded != 0) {
            ...
            if ($result['items_loaded'] < $items_all) {
                ...
                <div class="more_cont">
                    <a class="more_link" href="javascript:void(0)" onclick="Search.communitiesMore('<?php echo $result['itemId']; ?>'); return false;"><?php echo $LANG['action-more']; ?></a>
    ...
    $page_title = $LANG['label-groups']." | ".APP_TITLE;
                    ...
                    <div id="wrap1">
                        ...
                        <div id="content">
                            ...
                            <div class="header">
                                ...
                                <a href="/search/groups" class="title active"><?php echo $LANG['label-groups']; ?></a>
                                <span class="divider">|</span>
                            ...
                            <form id="search_form" method="get" action="/search/groups" class="frm">
                            ...
                            <div id="search_cont" class="search_cont">
                                ...
                                if (strlen($query) > 0) {
                                    ...
                                    ?>
                                        ...
                                        <div class="info">
                                            <?php echo $LANG['label-group-search-prompt']; ?>
                                        </div>
