...
//                $messages_count = $msg->getNewMessagesCount();
    ...
    public function updateCounters()
    {
        ...
        $stmt = $this->db->prepare("UPDATE users SET posts_count = (:posts_count), photos_count = (:photos_count), gifts_count = (:gifts_count), likes_count = (:likes_count), following_count = (:following_count), followers_count = (:followers_count) WHERE id = (:accountId)");
        $stmt->bindParam(":accountId", $this->id, PDO::PARAM_INT);
